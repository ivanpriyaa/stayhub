    ...
    <div class="d-flex">
        ...
        <div class="sidebar">
            ...
            <ul class="nav flex-column p-2">
                ...
                <li class="nav-item mb-1">
                    <a href="{{ url('/customer') }}"
                        class="nav-link inria-sans-regular {{ request()->is('customer*') ? 'active' : '' }}">
                ...
                <li class="nav-item mb-1">
                    <a href="{{ url('/villa') }}"
                        class="nav-link inria-sans-regular {{ request()->is('villa*') ? 'active' : '' }}">
                ...
                <li class="nav-item mb-1">
                    <a href="{{ url('/user') }}"
                        class="nav-link inria-sans-regular {{ request()->is('user*') ? 'active' : '' }}">
                ...
                <li class="nav-item mb-1">
                    ...
                    <a href="#" class="nav-link inria-sans-regular"
        ...
        <div class="content flex-grow-1 p-3 button">
            ...
            <button class="btn btn-menu mb-3 " id="toggleSidebar" style="background-color: #8A7650;color: #fff;">☰
                Menu</button>
