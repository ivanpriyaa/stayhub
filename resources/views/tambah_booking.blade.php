                ...
                <div class="card-body">
                    <form method="POST" action="/booking/store">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="time" class="form-control" name="checkin" value="{{ old('checkin', '14:00') }}" min="00:00" max="23:00" step="3600">
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Cek Out</label>
                            <input type="time" class="form-control" name="checkin" value="{{ old('checkin', '12:00') }}" min="00:00" max="23:00" step="3600">
